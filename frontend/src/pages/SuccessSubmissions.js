...
const SuccessSubmission = () => {
  ...
  const handleDownloadPDF = async () => {
    ...
    const { submissionId, userId, templateName, submittedDate, questions, selectedHierarchy } = submissionData;
    const doc = new jsPDF();
  ...
  return (
    <>
      ...
      <div className="success-submission-container">
        ...
        <p className="success-message">Your submission was successful! We appreciate your input.</p>

        <div className="success-details">
          <h2>Submission Details</h2>
          <p><strong>User ID:</strong> {submissionData?.userId}</p>
          <p><strong>Submission ID:</strong> {submissionData?.submissionId}</p>
          <p><strong>Template Name:</strong> {submissionData?.templateName}</p>
          <p><strong>Submitted Date:</strong> {new Date(submissionData?.submittedDate).toLocaleString()}</p>
        </div>
        ...
        <div className="success-actions">
          ...
          <button className="new-submission-button" onClick={() => navigate("/selectemplate")}>
